...
public class HSSFPatternFormatting implements com.wxiwei.office.fc.ss.usermodel.PatternFormatting
{
	...
	/**
	 * @see com.wxiwei.office.fc.hssf.record.cf.PatternFormatting#getFillBackgroundColor()
	 */
	...
	/**
	 * @see com.wxiwei.office.fc.hssf.record.cf.PatternFormatting#getFillForegroundColor()
	 */
	...
	/**
	 * @see com.wxiwei.office.fc.hssf.record.cf.PatternFormatting#getFillPattern()
	 */
	...
	/**
	 * @param bg
	 * @see com.wxiwei.office.fc.hssf.record.cf.PatternFormatting#setFillBackgroundColor(int)
	 */
	...
	/**
	 * @param fg
	 * @see com.wxiwei.office.fc.hssf.record.cf.PatternFormatting#setFillForegroundColor(int)
	 */
	...
	/**
	 * @param fp
	 * @see com.wxiwei.office.fc.hssf.record.cf.PatternFormatting#setFillPattern(int)
	 */
