...
public final class AutoShapes
{
     ...
     *
    */
    public static com.wxiwei.office.java.awt.Shape transform(com.wxiwei.office.java.awt.Shape outline, Rectangle2D anchor)
    {
    ...
    static
    {
        ...
        {
            public com.wxiwei.office.java.awt.Shape getOutline(Shape shape)
            {
